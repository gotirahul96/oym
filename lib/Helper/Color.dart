...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff480063);
  static const Color secondary = Color(0xffF5A61F);
  static const Color linear = Color(0xff313d73);

  Color get btnColor =>
      this.brightness == Brightness.dark ? whiteTemp : secondary;
