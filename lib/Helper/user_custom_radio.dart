                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: _item.addItem!.setDefault == "1"
                                        ? colors.primary
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(2.0),
                                  child: _item.addItem!.setDefault == "1"
                                      ? Icon(
                                          Icons.check,
                                          size: 15.0,
                                          color: Theme.of(context).colorScheme.white,
                                  ...
                                  child: Container(
                                    ...
                                    decoration: const BoxDecoration(
                                        borderRadius: BorderRadius.all(
                                            Radius.circular(4.0))),
                                    child: _item.addItem!.setDefault == "0"
                                        ? Text(
                                            getTranslated(
                                                context, 'SET_DEFAULT')!,
                                            style: TextStyle(
