...
back() {
  return BoxDecoration(
    gradient: LinearGradient(
        ...
        colors: [colors.primary, colors.linear],
        stops: [0, 1]),
  );
}
...
getAppBar(
  ...
  return AppBar(
    ...
    leading: Builder(builder: (BuildContext context) {
      return isBackButtonActive ? Container(
      ...
      Selector<UserProvider, String>(
        builder: (context, data, child) {
          ...
          return IconButton(
            icon: Stack(
              children: [
                Center(child: SvgPicture.asset(imagePath + "appbarCart.svg",color: Colors.white)),
...
Widget getNoItem(BuildContext context) {
  return Center(child: Image.asset('assets/mainimages/no.png',height: deviceHeight!/2));
}
