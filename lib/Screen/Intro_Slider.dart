...
import 'package:oym/Screen/SignInUpAcc.dart';
  ...
  void initState() {
    ...
    new Future.delayed(Duration.zero, () {
      setState(() {
        slideList = [
          Slide(
            imageUrl: 'assets/mainimages/1st.jpg',
            title: 'ON YOUR MIND',
            description: 'Shop best Brands that are On Your Mind.',
          ),
          Slide(
            imageUrl: 'assets/mainimages/2nd.jpg',
            title: 'Choose Your Products',
            description: 'Get variety of Products from different Sellers.',
          ),
          Slide(
            imageUrl: 'assets/mainimages/3rd.jpg',
            title: 'Delivery On Time',
            description: 'Get your Products delivered with NOWRAS EXPRESS any where in Oman.',
          ),
        ];
      });
    });
