  ...
  Widget detailsScreen() {
    return Column(
      children: [
        ...
        Text(
          widget.sellerName!,
          style: TextStyle(color: Theme.of(context).colorScheme.lightBlack2, fontSize: 16),
        ),
        Padding(
        ...
        Visibility(
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                  child: Text(
    (widget.storeDesc != "" || widget.storeDesc != null) ? "${widget.storeDesc}" : getTranslated(context, "NO_DESC")!,
