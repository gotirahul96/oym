...
class SignUpMobile extends StatefulWidget {
  ...
  SignUpMobile({Key? key, this.title}) : super(key: key);
...
class _SignUpMobileState extends State<SignUpMobile> with TickerProviderStateMixin {
  ...
  createAccTxt() {
    return Padding(
        ...
        child: Align(
          ...
          child: Text('We will send a OTP to this Number',
            style: Theme
                .of(context)
                .textTheme
                .subtitle1!
  ...
  Widget verifyCodeTxt() {
    return Padding(
        ...
        child: Align(
          alignment: Alignment.center,
          child: Text(
            'We will send a OTP to this Number.',
            textAlign: TextAlign.center,
            style: Theme
                .of(context)
                .textTheme
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      top: (MediaQuery.of(context).size.height * 0.19) - 50,
      //  bottom: height * 0.1,
      child: SizedBox(
        width: 100,
        height: 100,
