...
class _SignUpPageState extends State<SignUp> with TickerProviderStateMixin {
  ...
  String? name,
      ...
      id,token,
      referCode;
  FocusNode? nameFocus,mobileFocus,
      emailFocus,
      passFocus = FocusNode(),
  ...
  Future<void> getRegisterUser() async {
    try {
      var data = {
        ...
        'referedBy': referController.text.isNotEmpty ? referController.text : 'NO',
      };
      print(data);
      print(postSignupApi);
      Response response =
      await post(postSignupApi, body: data)
      ...
      if (error == 200) {
        ...
        settingProvider.saveUserDetail(id!, name, email, mobile, referCode, token,context);
  ...
  setUserName() {
    return Padding(
      ...
      child: TextFormField(
        ...
        onFieldSubmitted: (v) {
          _fieldFocusChange(context, nameFocus!, mobileFocus);
        },
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        validator: (val) => validateMob(
            val!,'Mobile No Required!','Invalid Number!'),
        onSaved: (String? value) {
          email = value;
        },
