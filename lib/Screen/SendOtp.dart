...
import 'package:oym/Screen/Privacy_Policy.dart';
...
class _SendOtpState extends State<SendOtp> with TickerProviderStateMixin {
  ...
  String? mobile, id, countryName, mobileno;
  ...
  Future<void> senEmailUser() async {
    try {
      var data = {'email': '${emailController.text}'};
      print(data);
      print(postForgotPasswordApi);
      Response response = await post(Uri.parse('https://www.oymsmartshop.com/oymApp/forgetPasswordAPI'),body: data);
      print(response.body);
  ...
  Widget verifyCodeTxt() {
    return Padding(
        ...
        child: Align(
          alignment: Alignment.center,
          child: Text(
            ///We will send the password on this Email id 
